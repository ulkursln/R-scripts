...
##Read Data
mydata<-read.delim("D:\\Folders\\doktora\\TIK4\\Analizler\\analysis_for_rawData\\RData\\RData_numberOfGazeAversionsExtended.txt", sep= " ", header =T)
names(mydata)
...
nrow(mydata)
mydata_withoutOutlier<-mydata[which(mydata$InterviewerFrequency <66),]
